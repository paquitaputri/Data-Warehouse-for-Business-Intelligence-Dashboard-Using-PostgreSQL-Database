...
class FaktaPengiriman(models.Model):
    ...
    def __str__(self):
        return str(self.nomer, self.mode_pengiriman, self.kota, self.pelanggan, self.tanggal, self.barang_diterima)
    
    def __str__(self):
        return str(self.pesanan)
...
class FaktaPenjualan(models.Model):
    ...
    def __str__(self):
        return str(self.nomer, self.kota, self.tanggal, self.pelanggan, self.segmen, self.harga, self.profit, self.jumlah_barang)
